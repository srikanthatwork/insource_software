...
import { Menu, X, ChevronDown, Stars } from "lucide-react";
import logo from "../../../src/components/assets/insource-removebg.png";
import RequestDemoForm from "../common/RequestDemoForm"; 
                    ...
                    >
                      ...
                      {productsOpen && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0, scale: 1 }}
                          exit={{ opacity: 0, y: 10, scale: 0.95 }}
                          className="absolute top-full left-0 w-80 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50"
                        >
                          {item.dropdownItems?.map((dropdownItem, index) => (
                            <motion.div
                              key={dropdownItem.name}
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1">
                      ...
                      <>
                        ...
                        {mobileSolutionsOpen && (
                          <motion.div
                            initial={{ opacity: 0, height: 0 }}
                            animate={{ opacity: 1, height: "auto" }}
                            className="ml-4 space-y-1 border-l-2 border-blue-200 pl-3"
                          >
                ...
                <motion.div whileTap={{ scale: 0.95 }} className="pt-2">
                  <button
                    onClick={handleRequestDemo}
                    className="block w-full text-center bg-gradient-to-r from-blue-500 to-blue-900 text-white px-6 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Request a Demo
                  </button>
                </motion.div>
