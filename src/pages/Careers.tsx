...
import { careerQuote, jobOpenings } from '../data/company';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
              Be part of a team that's revolutionizing healthcare through innovative technology solutions.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <Card className="p-12 text-center bg-gradient-to-br from-blue-50 to-purple-50">
              ...
              <cite className="text-gray-600 font-medium">- Insource Leadership Team</cite>
            </Card>
          </AnimatedSection>
        </div>
      </section>
