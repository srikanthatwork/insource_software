...
// //                One Platform Unified Intelligence. Seamless Connectivity
// //               </span>
// //             </h1>
// //             <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
// //              Insource Software goes beyond individual applications — it delivers a <strong>unified ecosystem </strong>where all products (HEALTH+, HCM, IDM, FFA) communicate through secure APIs, shared analytics, and a single source of truth.
// // This cross-integration ensures complete visibility, data consistency, and real-time decision-making across every business function.
// // Built on <strong>microservices, AI-driven data pipelines, and modular APIs,</strong> the Insource ecosystem adapts dynamically to each client’s structure — from a single hospital to a multi-country enterprise.
